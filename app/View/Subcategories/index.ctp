<div class="subcategories index">
	...
	<tr>
		...
		<td><?php echo h($subcategory['Subcategory']['description']); ?>&nbsp;</td>
		<td><?php echo h($subcategory['Subcategory']['date_created']); ?>&nbsp;</td>
		<td><?php echo h($subcategory['Subcategory']['date_modified']); ?>&nbsp;</td>
		<td class="actions">
