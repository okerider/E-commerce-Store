...
<?php echo $this->Form->create('Retail'); ?>
	<fieldset>
		<legend><?php echo __('Edit Retail'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Retail.id')), array(), __('Are you sure you want to delete # %s?', $this->Form->value('Retail.id'))); ?></li>
