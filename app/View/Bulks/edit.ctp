...
<?php echo $this->Form->create('Bulk'); ?>
	<fieldset>
		<legend><?php echo __('Edit Bulk'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Bulk.id')), array(), __('Are you sure you want to delete # %s?', $this->Form->value('Bulk.id'))); ?></li>
